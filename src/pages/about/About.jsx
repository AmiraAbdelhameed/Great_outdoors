...
import AboutImg from '../../Assets/images/Camping-cuate.svg'
const About=()=>{
    return(
        <>
        <section className="portofolio bg-black text-white min-h-screen py-16 ">
        <div className="px-8  sm:container py-3  sm:mx-auto flex  flex-wrap gap-4 justify-around items-center">
            <h2 className="font-bold text-3xl">About us</h2>
                    <div className="flex justify-around items-center gap-8 my-16 flex-col md:flex-row">
                <figure className="w-[80%] md:w-[40%]">
                    <img src={AboutImg} alt="" className="w-[100%]" />
                </figure>
                <div className="content w-[80%] md:w-[50%]">
